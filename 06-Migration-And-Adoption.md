...
session_id: "audit-worker-06-migration"
host_info:
...
[^2]: "TurboModules". React Native Documentation. [https://reactnative.dev/docs/the-new-architecture/pillars-turbomodules](https://reactnative.dev/docs/the-new-architecture/pillars-turbomodules)
[^3]: "Fabric Native Components". React Native Documentation. [https://reactnative.dev/docs/the-new-architecture/pillars-fabric-components](https://reactnative.dev/docs/the-new-architecture/pillars-fabric-components)
